...
function loadOffers(page) {
    ...
    xhr.open("GET", "/offers/get-list?page=" + page + "&perPage=" + perPage, true);
...
function renderOffers(offers) {
    ...
    html += "<thead><tr><th scope='col'>ID</th><th scope='col'>Название</th><th scope='col' >Активен</th><th scope='col'>URL</th><th scope='col'>Стоимость перехода</th><th scope='col'>Подписок</th><th scope='col'>Дата и время</th><th scope='col'>&nbsp;</th></tr></thead>";
    html += "<tbody>";
    for (let i = 0; i < offers.length; i++) {
        ...
        html += "<td>" + offers[i].cost_per_click + "</td>";
        html += "<td>" + offers[i].subscriptions_count + "</td>";
